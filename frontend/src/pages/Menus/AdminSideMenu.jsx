...
import { LayoutDashboard, Package, Warehouse, ClipboardList, Users, ArrowLeftRight, LogOut, Moon, Sun, Truck, UserCheck } from 'lucide-react';

function AdminSideMenu({ isOpen, onClose, onLogout }) {
  ...
  const menuItems = [
    ...
    { label: 'Stocks',          icon: ClipboardList,    path: '/admin/stocks' },
    { label: 'Users',           icon: Users,            path: '/admin/users' },
    { label: 'Stock Movements', icon: ArrowLeftRight,   path: '/admin/stockmovements' },
    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '24px', borderBottom: '1px solid var(--sidebar-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 'bold', color: 'var(--text-primary)' }}>WMS Admin</h2>
